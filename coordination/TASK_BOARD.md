...
## 현재 우선순위
- [~] H-020 진행중: fallback warning 샘플 확보 실행률 추적 정합화 (최근 7일 목표 대비 실행량/달성률 추적 + 14일 게이트 판정 연계 + `READY/HOLD` 입력 강화)
