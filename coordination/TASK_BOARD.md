...
## 현재 우선순위
- [~] H-024 진행중: fallback warning 실행량 회복 액션 최소 이행률 하한선/증거 규약 고정 (일일 하한선 PASS/FAIL + 주간 이행률 단계 분류 + `LOW_TRAFFIC`/`CHAIN_COVERAGE_GAP` 증거 ledger 표준화)
