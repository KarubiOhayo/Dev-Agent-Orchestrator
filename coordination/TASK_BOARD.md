...
## 현재 우선순위
- [~] H-021 진행중: fallback warning 실행량 증대 검증용 호출 믹스 추적 (최근 7일 직접 호출 vs 체인 호출 비중 추적 + 14일 게이트 판정/`READY/HOLD` 근거 강화)
